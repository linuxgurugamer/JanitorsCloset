...
namespace JanitorsCloset
{
    class ShowRenamed : MonoBehaviour
    {
        ...
        const int RENAMED_WIN_HEIGHT = 500;
        ...
        public void ShowRenamedWin()
        {
            enabled = true;
            renamedList = new List<string>();
        }

        public void addLineToRenamedList(string str)
        {
            renamedList.Add(str);
        }
        ...
        {
            innerCoords = new Rect(0, LINEHEIGHT, UnityEngine.Screen.width - 300, RENAMED_WIN_HEIGHT - 2 * LINEHEIGHT);
...
//            GUILayout.BeginArea(innerCoords);
            sitesScrollPosition = GUILayout.BeginScrollView(sitesScrollPosition, false, true, GUILayout.Height(RENAMED_WIN_HEIGHT - LINEHEIGHT));
            //GUI.enabled = false;
            GUILayout.Label(t);
            //GUI.enabled = true;
            GUILayout.EndScrollView();
